        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
              Thank you for choosing Geelong Movement Co. We're excited to help you move freely again.
            </p>
          </div>
              ...
              <div className="space-y-4 text-left">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our team will contact you within 1 business day to confirm your preferred appointment time.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Your comprehensive FMS evaluation will identify movement limitations and create your personalized
                      plan.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Personalized Movement Plan</h3>
                    <p className="text-muted-foreground">
                      Leave with a clear understanding of your movement patterns and a plan to train around any
                      limitations.
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground">Questions about your appointment?</p>
