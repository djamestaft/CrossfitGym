        ...
        <header className="bg-gradient-to-b from-muted to-background py-12">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">{hub.title}</h1>
              <p className="text-xl text-muted-foreground mb-6 text-balance">{hub.description}</p>
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <Card className="bg-primary text-primary-foreground">
                  <CardContent className="pt-6">
                    <h2 className="text-xl font-semibold mb-2">Get Personalized Help</h2>
                    <p className="mb-4 opacity-90">
                      Book a free FMS assessment to get a personalized movement plan for your specific needs.
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-3">
                      Have questions about your specific situation? Our team is here to help.
                    </p>
