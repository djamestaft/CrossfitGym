...
const coaches: Coach[] = [
  {
    ...
    specializations: ["Shoulder & Neck Pain", "Workplace Ergonomics", "Women's Health", "Postural Correction"],
    experience: "12 years",
  ...
  },
  {
    ...
    specializations: ["Sports Injuries", "Lower Back Pain", "Return to Sport Programs", "Strength & Conditioning"],
    experience: "15 years",
  ...
  },
  {
    ...
    specializations: ["Chronic Pain Management", "Hip & Knee Conditions", "Movement Re-education", "Clinical Pilates"],
    experience: "8 years",
...
export function CoachBio({ showAll = false, maxItems = 3, layout = "grid" }: CoachBioProps) {
...
function CoachCard({ coach, layout }: { coach: Coach; layout: "grid" | "list" }) {
  if (layout === "list") {
    return (
      <Card>
            ...
            <div className="space-y-4">
              ...
              <div className="text-center md:text-left">
                ...
                <div className="flex items-center gap-1 justify-center md:justify-start mb-1">
                  ...
                  <span className="text-xs text-muted-foreground">{coach.experience} experience</span>
                </div>
  ...
  return (
    <Card className="h-full">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm leading-relaxed">{coach.bio.substring(0, 150)}...</p>
