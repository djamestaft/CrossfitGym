...
const movementVideos: MovementVideo[] = [
  {
    ...
    description: "Strengthen your rhomboids and middle trapezius to improve posture and reduce shoulder pain.",
    duration: "3:45",
  ...
  },
  {
    ...
    description: "Improve spinal mobility and reduce lower back stiffness with this gentle movement.",
    duration: "4:20",
    category: "Mobility",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    description: "Core stability exercise that teaches proper coordination and spinal control.",
    duration: "5:15",
  ...
  },
  {
    ...
    description: "Release tight hip flexors from prolonged sitting and improve hip mobility.",
    duration: "3:30",
    category: "Stretching",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    description: "Improve mid-back mobility and reduce stiffness from desk work.",
    duration: "4:45",
    category: "Mobility",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    description: "Strengthen glutes and improve hip stability for better movement patterns.",
    duration: "4:00",
    category: "Strengthening",
    difficulty: "Intermediate",
  ...
  },
  {
    id: "7",
    title: "Wall Slides",
    description: "Improve shoulder blade control and strengthen the posterior chain.",
    duration: "3:15",
    category: "Strengthening",
    difficulty: "Beginner",
    bodyPart: ["Shoulders", "Upper Back"],
  ...
  },
  {
    id: "8",
    title: "Bird Dog",
    description: "Enhance core stability and coordination while strengthening the posterior chain.",
    duration: "4:30",
    category: "Core Stability",
    difficulty: "Intermediate",
  ...
  },
  {
    ...
    description: "Build core strength progressively with proper plank technique.",
    duration: "6:00",
    category: "Core Stability",
    difficulty: "Advanced",
  ...
  },
  {
    ...
    description: "Targeted exercises to strengthen and protect your rotator cuff muscles.",
    duration: "7:30",
    category: "Strengthening",
    difficulty: "Advanced",
    bodyPart: ["Shoulders"],
...
export function MovementLibrary() {
  ...
  const categories = ["All", ...Array.from(new Set(movementVideos.map((video) => video.category)))]
  ...
  const filteredVideos = movementVideos.filter((video) => {
    const matchesSearch =
      ...
      video.bodyPart.some((part) => part.toLowerCase().includes(searchTerm.toLowerCase()))
        ...
        {filteredVideos.map((video) => (
          <Card key={video.id} className="group hover:shadow-lg transition-shadow">
            ...
            <CardContent className="pt-0">
              ...
              <Button className="w-full" onClick={() => handleVideoPlay(video.id, video.title)}>
