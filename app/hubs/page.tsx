...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive guides to understanding and managing common movement and pain conditions.',
  openGraph: {
    title: 'Health Hubs | Geelong Movement Co',
    description:
      'Expert guides for shoulder pain, back pain, and movement health.',
  },
}
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center space-y-6'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold text-balance'>
              Movement Health Hubs
            </h1>
            <p className='text-xl text-muted-foreground text-balance max-w-2xl mx-auto'>
              Expert-curated guides to help you understand and manage common
              movement conditions. Evidence-based information from our qualified
              physiotherapists.
            </p>
          </div>
        </div>
                  ...
                  <CardContent className='space-y-4'>
                    ...
                    <div className='flex items-center gap-4 text-sm text-muted-foreground'>
                      ...
                      <div className='flex items-center gap-1'>
                        ...
                        <span>
                          Updated{' '}
                          {new Date(hub.lastUpdated).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center space-y-6'>
            ...
            <p className='text-muted-foreground'>
              While our health hubs provide valuable information, nothing
              replaces a personalized assessment. Book your free FMS evaluation
              to get a customized movement plan.
            </p>
