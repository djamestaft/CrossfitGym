...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Geelong Movement Co - Train Around Pain, Move Freely Again",
    description: "Professional movement therapy and functional movement screening in Geelong.",
    type: "website",
    locale: "en_AU",
...
const organizationSchema = {
  ...
  sameAs: ["https://www.facebook.com/geelongmovementco", "https://www.instagram.com/geelongmovementco"],
}
